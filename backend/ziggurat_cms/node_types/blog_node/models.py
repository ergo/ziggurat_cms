...
class BlogNode(Resource):
    __tablename__ = 'zigguratcms_blog_nodes'
    __mapper_args__ = {'polymorphic_identity': 'zigguratcms-blog-node'}
    ...
    listed_elements = sa.orm.relationship(
        ...
        primaryjoin="and_(BlogNode.resource_id == foreign(NodeElement.resource_id),"
