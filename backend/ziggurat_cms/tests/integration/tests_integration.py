...
from ziggurat_cms.tests.utils import tmp_session_context
...
def dummy_request(dbsession):
    ...
    req = testing.DummyRequest(base_url='http://ziggurat_cms.com',
                               dbsession=dbsession)
...
class TestUsersAPI(object):
    def test_wrong_post(self, sqla_session):
        from ziggurat_cms.views.api.users import UserAPIView
        import marshmallow
